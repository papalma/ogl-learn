// What's new:
// - Colors from vertices array were removed. Remains triangle positions and texture cords.
// - Added model, view and projection matrices to source code and to shader code.
